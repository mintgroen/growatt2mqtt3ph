...
#define MODBUS_RATE     9600      // Modbus speed of Growatt, do not change
  ...
  private:
    ...
    {
      int status;
      float solarpower, pv1voltage, pv1current, pv1power, pv2voltage, pv2current, pv2power, outputpower, gridfrequency, gridph1voltage, gridph2voltage, gridph3voltage, lineph1voltage, lineph2voltage, lineph3voltage;
